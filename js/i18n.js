...
const STRINGS = {
  es: {
    ...
    bookingBody: "Esta sección es un placeholder. En producción, agenda con manejo de husos horarios, reprogramación flexible y verificación de consentimiento.",
  ...
  en: {
    ...
    bookingBody: "This is a placeholder. In production, handle time zones, flexible rescheduling, and consent checks.",
  ...
  pt: {
    ...
    bookingBody: "Placeholder. Em produção: fusos horários, remarcação flexível e checagem de consentimento.",
